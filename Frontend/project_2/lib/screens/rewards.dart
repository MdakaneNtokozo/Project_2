...
class _RewardsState extends State<Rewards> {
  ...
  void initState() {
    ...
    var response2 = ApiCalls().getWeeksInfo(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            infoRetrieved == true && members.isNotEmpty
                ? ListView.builder(
                    shrinkWrap: true,
                    ...
                    itemBuilder: (context, idx) {
                      ...
                      //   var m = members[i];
                      //   if (m.familyMemberId == rewardWon.familyMemberId) {
                      //     member = m;
                      //   }
                      // }
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  rewardWon.rewardId == -1 &&
                                          rewardWon.familyMemberId == -1
                                      ? Text("Ongoing")
                                      : Text(
                                          "Winner: ${member.familyMemberName} ${member.familyMemberSurname}",
                                        ),
                                ],
                              ),
                            ],
